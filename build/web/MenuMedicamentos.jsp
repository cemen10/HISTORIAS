                    ...
                    <center>
                        <div class="container">                        
                          <div style="width: 80%;">
                            ...
                            <div class="onecolumn">
                                <div class="header">
                                    <span><CENTER>MENU MEDICAMENTOS</CENTER> </span>
                                </div>
                                <br class="clear"/>
                                                ...
                                                <table>
                                                    <tr>                                                   
                                                        <td>
                                                            <ul id="shortcut">
                                                                <li>
                                                                    <a href="ges_manejo_medica" title="Manejo de Medicamentos"  style="width: 100px; height: 100px;">
                                                                        <img  src="images/medicamentos.png" width="48" height="48"  style=" border: 0px;" alt=""/><br/>
                                                                        <strong>Manejo de Medicamentos<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </td>     
                                                        <td>
                                                            <ul id="shortcut">
                                                                <li>
                                                                    <a href="ges_formula" title="Formula Medica"  style="width: 100px; height: 100px;">
                                                                        <img  src="images/medicamentos.png" width="48" height="48" style=" border: 0px;" alt=""/><br/>
                                                                        <strong>FORMULA MEDICA<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </td>     
