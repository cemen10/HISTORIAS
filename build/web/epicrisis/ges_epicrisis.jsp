...
<%
    try {
        ...
        String diag= (String) session.getAttribute("diag");   
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <script type="text/javascript" src="../js/funcion_epicrisis.js"></script>
    ...
    <body>
        ...
        <div class="content_wrapper">
            ...
            <!--/////////////////////COPIAR DESDE AQUI////////////////////////////-->
                     ...
                     <!--////////////////BUSQUEDA EPICRISIS/////////////////////-->                     
                     <div id='busqueda_epicrisis' style='width: 70%;height: 600px; margin-left: 2%; padding-left: 15px; padding-right: 15px; display: none;'>
                         <label id="cer_venepi" style='cursor: pointer; margin-top: 2px; margin-right: 2px; float: right;'><img src='../images/cerrar_red.png' title='Cerrar Ventana'></label>
                         <center><label style="margin-top: 10px;" id='titbus'></label></center>
                         <div class="inner" style='width: 100%'>
                             <center><h1>EPICRISIS</h1></center>
                            ...
                            <div class="redondo" style="height: 50px; margin: 2% 0 0 87%;width: 106px;">
                                <ul id="shortcut" style="margin-top: 0px;text-align: right;">
                                    <li>
                                        <a id="cer_venepi" href="#" title="Cancelar">
                                            <img src="../images/cancel.png" alt="Cancelar"><br>
                                        </a>
                                    </li>
                                    <!--<li>
                     ...
                     <!--//////////////////////////////////////////////////////////////////////-->    
                        ...
                        <div class="container">
                            <div style="width: 100%">
                                <div class="onecolumn">
                                    <div class="header">
                                        <span><center>Registrar Epicrisis</center></span>
                                    </div>
                                    <!--<br class="clear">-->
                                    ...
                                    <!--<div style="height: 980px; width: 95%;" id='cp'>-->                                            
                                        <div id='conte'  style="height: 400px; width: 100%;">  
                                            ...
                                            <ul class='tabs'>
                                                ...
                                                <li id='td2'><a href='#tab2' style='font-size: 14px;font-weight: bold;'>B. DIAGNOSTICO Y TRATAMIENTO</a></li>
                                                <li id='td3'><a href='#tab3' style='font-size: 14px;font-weight: bold;' >C. ORDENAMIENTO</a></li>
                                            </ul>
                                            <form id='form_epicrisis' name='form_epicrisis' action='' method='POST'>                                                                                            
