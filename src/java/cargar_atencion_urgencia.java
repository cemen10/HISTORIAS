 ...
 * @author carlosmario
 */
public class cargar_atencion_urgencia extends HttpServlet {
        ...
        try {
            if(usuario==null){
                ...
                if(auxiliar.equals("PACIENTES")){
                    ...
                    String combusaten=request.getParameter("combusaten");
                    String txtbusaten=request.getParameter("txtbusaten");
                    if(combusaten.equals("IDENTIFICACION")){
                        sql="SELECT "
                            ...
                            + "WHERE pacientes.ident_paciente LIKE '" + txtbusaten + "%' "
                            + "LIMIT 20";
                    }
                    if(combusaten.equals("HISTORIA")){
                        sql="SELECT "
                            + "pacientes.histor_paciente,"
                            + "pacientes.ident_paciente,"
                            + "pacientes.nomb_paciente,"
                            ...
                            + "FROM pacientes INNER JOIN mun "
                            + "ON pacientes.mun_paciente=mun.id "                                  
                           + "WHERE pacientes.histor_paciente LIKE '" + txtbusaten + "%' "
                           + "LIMIT 20";
                    }           
                    if(combusaten.equals("NOMBRE")){
                        txtbusaten=txtbusaten.replace("+", " ");
                        buscar=txtbusaten.split(" ");
