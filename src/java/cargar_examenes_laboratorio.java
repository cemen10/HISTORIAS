 ...
 * @author carlosmario
 */
public class cargar_examenes_laboratorio extends HttpServlet {
        ...
        try {
            if(usuario==null){
                ...
                if(auxiliar.equals("PACIENTES")){
                    ...
                    String combuslabo=request.getParameter("combuslabo");
                    String txtbuslabo=request.getParameter("txtbuslabo");                    
                    if(combuslabo.equals("IDENTIFICACION")){
                        sql="SELECT "
                            ...
                            + "WHERE pacientes.ident_paciente LIKE '" + txtbuslabo + "%' "
                            + "LIMIT 20";                        
                    }
                    
                    if(combuslabo.equals("NOMBRE")){
                        txtbuslabo=txtbuslabo.replace("+", " ");
                        buscar=txtbuslabo.split(" ");
                    ...
                    if(combuslabo.equals("HISTORIA")){
                        sql="SELECT "
                            ...
                            + "FROM pacientes INNER JOIN mun "
                            + "ON pacientes.mun_paciente=mun.id "                                                            
                            + "WHERE pacientes.histor_paciente LIKE '" + txtbuslabo + "%' "                                
                            + "LIMIT 20";                        
                    }
                    if(txtbuslabo.equals("")){
                       labora=""; 
                    }else{
                        String nomcompleto="";
                        ...
                        int j=1;
                        int contador=0;
                        labora= "<div style='width:100%; height: 105px; overflow: auto;'>"
