...
<%
    try {
        ...
        String soli= (String) session.getAttribute("soli");     
        String orde= (String) session.getAttribute("orde");     
        if (usuario == (null)) {
            usuario = "";
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <!-- Website Title -->
        <title>SGPS - REMISION DE PACIENTES</title>
        <!-- Meta data for SEO -->
        ...
        <script type="text/javascript" src="../js/funcion_remision.js"></script>
            ...
            <div id="content">                                
                <div class="inner">
                    ...
                    <hr/>                   
                     ...
                     <!--////////////////BUSQUEDA REMISION/////////////////////-->                     
                     <div id='busqueda_remision' style='width: 70%;height: 600px; margin-left: 2%; padding-left: 15px; padding-right: 15px; display: none;'>
                         <label id="cer_venremi" style='cursor: pointer; margin-top: 2px; margin-right: 2px; float: right;'><img src='../images/cerrar_red.png' title='Cerrar Ventana'></label>
                         <center><label style="margin-top: 10px;" id='titbus'></label></center>
                         <div class="inner" style='width: 100%'>
                             <center><h1>REMISI&Oacute;N DE PACIENTES</h1></center>
                             <form id='form_epi' name='form_epi' action='' method='POST'>
                                 ...
                                 <table id='tablafecha' style='display: none;'>
                                     <tr>
                                         <td><label>FECHA DE REMISI&Oacute;N:</label></td>
                                 ...
                                 <div class='onecolumn' id='area_fecha'  style='display: none;'>
                                     <div class="header">
                                         <span>REMISI&Oacute;N DE PACIENTES</span>                                         
                                     </div>
                                     <br class="clear">
                                     <div style="height: 123px;">
                                         <div class='content'>
                                             <div align='center' style='float:left; width: 100%;'>                                                 
                                                 <div id='zona_remision2' >
                            ...
                            <div class="redondo" style="height: 50px; margin: 2% 0 0 87%;width: 106px;">
                                <ul id="shortcut" style="margin-top: 0px;text-align: right;">
                                    <li>
                                        <a id="cer_venremi" href="#" title="Cancelar">
                                            <img src="../images/cancel.png" alt="Cancelar"><br>
                                        </a>
                                    </li>
                                    <!--<li>
                     ...
                     <!--//////////////////////////////////////////////////////////////////////-->                                                
                        <div class="container">
                            <div style="width: 100%">
                                <div class="onecolumn">
                                    <div class="header">
                                        <span><center>Registrar Remisi&oacute;n de Pacientes</center></span>
                                    </div>
                                    <!--<br class="clear">-->
                                    ...
                                    <!--<div style="height: 980px; width: 95%;" id='cp'>-->                                            
                                        <div id='conte'  style="height: 400px; width: 100%;">  
                                            ...
                                            <ul class='tabs'>
                                                ...
                                                <li id='td2'><a href='#tab2' style='font-size: 14px;font-weight: bold;'>B. IDENTIFICACI&Oacute;N DE INSTITUCIONES</a></li>
                                                <li id='td3'><a href='#tab3' style='font-size: 14px;font-weight: bold;' >C. SOLICITUD DE ATENCI&Oacute;N</a></li>
                                                <li id='td4'><a href='#tab4' style='font-size: 14px;font-weight: bold;' >D. ORDENAMIENTO</a></li>
                                            </ul>
                                            <form id='form_remision' name='form_remision' action='' method='POST'>                                                                                            
