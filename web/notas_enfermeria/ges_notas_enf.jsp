...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <!-- Website Title -->
        <title>SGPS - NOTAS DE ENFERMERIA</title>
        <!-- Meta data for SEO -->
        ...
        <script type="text/javascript" src="../js/funcion_notas_enf.js"></script>
            ...
            <div id="content">                                
                <div class="inner">
                    ...
                    <hr/>                   
                     ...
                     <!--////////////////BUSQUEDA NOTAS/////////////////////-->                     
                     <div id='busqueda_notas' style='width: 70%;height: 600px; margin-left: 2%; padding-left: 15px; padding-right: 15px; display: none;'>
                         <label id="cer_vennot" style='cursor: pointer; margin-top: 2px; margin-right: 2px; float: right;'><img src='../images/cerrar_red.png' title='Cerrar Ventana'></label>
                         <center><label style="margin-top: 10px;" id='titbus'></label></center>
                         <div class="inner" style='width: 100%'>
                             ...
                             <form id='form_not' name='form_not' action='' method='POST'>
                                 ...
                                 <table id='tablafecha' style='display: none;'>
                                     <tr>
                                         <td><label>ID NOTA:</label></td>
                                         <td><input type='text' size='9'  name='tfec' id='tfec' style='opacity: 1;'></td> 
                            ...
                            <div class="redondo" style="height: 50px; margin: 2% 0 0 87%;width: 106px;">
                                <ul id="shortcut" style="margin-top: 0px;text-align: right;">
                                    <li>
                                        <a id="cer_vennot" href="#" title="Cancelar">
                                            <img src="../images/cancel.png" alt="Cancelar"><br>
                                        </a>
                                    </li>
                                </ul>
                     ...
                     <!--//////////////////////////////////////////////////////////////////////-->   
                        ...
                        <div class="container">
                            <div style="width: 100%">
                                <div class="onecolumn">
                                    <div class="header">
                                        <span><center>Registrar Notas de Enfermeria</center></span>
                                    </div>
                                    <!--<br class="clear">-->
                                    ...
                                    <!--<div style="height: 980px; width: 95%;" id='cp'>-->                                            
                                        <div id='conte'  style="height: 400px; width: 100%;">  
                                            ...
                                            <ul class='tabs'>
                                                ...
                                                <li id='td2'><a href='#tab2' style='font-size: 14px;font-weight: bold;'>B.NOTAS</a></li>
                                            </ul>
