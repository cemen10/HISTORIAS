...
<%
    try {
        ...
        String mane= (String) session.getAttribute("mane");
        String liqui= (String) session.getAttribute("liqui");
        if (usuario == (null)) {
            usuario = "";
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <!-- Website Title -->
        <title>SGPS - MANEJO MEDICAMENTOS</title>
        <!-- Meta data for SEO -->
        ...
        <script type="text/javascript" src="../js/funcion_manejo_medica.js"></script>
            ...
            <div id="content">                                
                <div class="inner">
                    ...
                    <hr/>                   
                     ...
                     <!--////////////////BUSQUEDA EPICRISIS/////////////////////-->                     
                     <div id='busqueda_manejo' style='width: 70%;height: 600px; margin-left: 2%; padding-left: 15px; padding-right: 15px; display: none;'>
                         <label id="cer_venmane" style='cursor: pointer; margin-top: 2px; margin-right: 2px; float: right;'><img src='../images/cerrar_red.png' title='Cerrar Ventana'></label>
                         <center><label style="margin-top: 10px;" id='titbus'></label></center>
                         <div class="inner" style='width: 100%'>
                             <center><h1>MANEJO DE MEDICAMENTOS</h1></center>
                             <form id='form_man' name='form_man' action='' method='POST'>
                                 <table>
                                     <tr>
                                         <td><label>BUSCAR PACIENTES POR:</label></td>
                                         <td>
                            ...
                            <div class="redondo" style="height: 50px; margin: 2% 0 0 87%;width: 106px;">
                                <ul id="shortcut" style="margin-top: 0px;text-align: right;">
                                    <li>
                                        <a id="cer_venmane" href="#" title="Cancelar">
                                            <img src="../images/cancel.png" alt="Cancelar"><br>
                                        </a>
                                    </li>
                                    <!--<li>
                     ...
                     <!--//////////////////////////////////////////////////////////////////////-->                            
                        ...
                        <div class="container">
                            <div style="width: 100%">
                                <div class="onecolumn">
                                    <div class="header">
                                        <span><center>Registrar Manejo de Medicamentos</center></span>
                                    </div>
                                    <!--<br class="clear">-->
                                    ...
                                    <!--<div style="height: 980px; width: 95%;" id='cp'>-->                                            
                                        <div id='conte'  style="height: 400px; width: 100%;">  
                                            <center>
                                            <ul class='tabs'>
                                                <li id='td1'><a href='#tab1' style='font-size: 14px;font-weight: bold;'>A. IDENTIFICACI&Oacute;N</a></li>
                                                <li id='td2'><a href='#tab2' style='font-size: 14px;font-weight: bold;'>B.LIQUIDACI&Oacute;N</a></li>
                                                <li id='td3'><a href='#tab3' style='font-size: 14px;font-weight: bold;'>C.MANEJO MEDICAMENTOS</a></li>
                                            </ul>
                                            <form id='form_manejo' name='form_manejo' action='' method='POST'>                                                                                            
