...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <head>
        ...
        <!-- Website Title -->
        <title>SGPS - CONSULTA EXTERNA</title>
        <!-- Meta data for SEO -->
                    ...
                    <center>
                        <div class="container">                        
                          <div style="width: 80%;">
                            ...
                            <div class="onecolumn">
                                <div class="header">
                                    <span><CENTER>MENU CONSULTA EXTERNA</CENTER> </span>
                                </div>
                                <br class="clear"/>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <ul id="shortcut">
                                                                <li>
                                                                    <a href="ges_materno_per" title="Materno Perinatal"  style="width: 100px; height: 100px;">
                                                                        <img  src="images/hd.png" width="48" height="48" style=" border: 0px;" alt=""/><br/>
                                                                        <strong>Materno Perinatal<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </td>         
                                                        <td>
                                                            <ul id="shortcut">
                                                                <li>
                                                                    <a href="#" title="Crecimiento y Desarrollo"  style="width: 100px; height: 100px;">
                                                                        <img  src="images/hd.png" width="48" height="48" style=" border: 0px;" alt=""/><br/>
                                                                        <strong>Crecimiento y Desarrollo<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </td>      
                                                        <td>
                                                            <ul id="shortcut">
                                                                <li>
                                                                    <a href="#" title="Detecci&oacute;n Temprana"  style="width: 100px; height: 100px;">
                                                                        <img  src="images/hd.png" width="48" height="48" style=" border: 0px;" alt=""/><br/>
                                                                        <strong>Detecci&oacute;n Temprana<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </td>       
                                                        <td>
                                                            <ul id="shortcut">
                                                                <li>
                                                                    <a href="#" title="Planificaci&oacute;n Familiar"  style="width: 100px; height: 100px;">
                                                                        <img  src="images/hd.png" width="48" height="48" style=" border: 0px;" alt=""/><br/>
                                                                        <strong>Planificaci&oacute; Familiar<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </td>                                                            
