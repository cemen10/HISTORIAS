...
<%
    try {
        ...
        String ingreso= (String) session.getAttribute("ingreso");   
        String evolucion= (String) session.getAttribute("evolucion");
        String egreso= (String) session.getAttribute("egreso");             
        if (usuario == (null)) {
            usuario = "";
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <!-- Website Title -->
        <title>SGPS - EPICRISIS ATENCION DE URGENCIAS</title>
        <!-- Meta data for SEO -->
        ...
        <script type="text/javascript" src="../js/funcion_epicrisis_aten.js"></script>        
    ...
    <body>
        ...
        <div class="content_wrapper">
            ...
            <div id="content">                                
                <div class="inner">
                    <h1>EPICRISIS ATENCION DE URGENCIAS</h1>
                    <hr/>                   
            <!--/////////////////////COPIAR DESDE AQUI////////////////////////////-->
                     ...
                     <!--////////////////BUSQUEDA EPICRISIS ATENCION DE URGENCIAS/////////////////////-->                     
                     <div id='busqueda_epicrisis_aten' style='width: 70%;height: 600px; margin-left: 2%; padding-left: 15px; padding-right: 15px; display: none;'>
                         <label id="cer_venepiaten" style='cursor: pointer; margin-top: 2px; margin-right: 2px; float: right;'><img src='../images/cerrar_red.png' title='Cerrar Ventana'></label>
                         <center><label style="margin-top: 10px;" id='titbus'></label></center>
                         <div class="inner" style='width: 100%'>
                             <center><h1>EPICRISIS ATENCION DE URGENCIAS</h1></center>
                             <form id='form_epicrisis_atencion' name='form_epicrisis_atencion' action='' method='POST'>
                                 <table>
                                     <tr>
                                         <td><label>BUSCAR PACIENTES POR:</label></td>
                                         <td>
                                 ...
                                 <div class='onecolumn' id='area_fecha'  style='display: none;'>
                                     <div class="header">
                                         <span>EPICRISIS ATENCION DE URGENCIAS</span>                                         
                                     </div>
                                     <br class="clear">
                                     <div style="height: 123px;">
                                         <div class='content'>
                                             <div align='center' style='float:left; width: 100%;'>                                                 
                                                 <div id='zona_epicrisis_aten2' >
                            ...
                            <div class="redondo" style="height: 50px; margin: 2% 0 0 87%;width: 106px;">
                                <ul id="shortcut" style="margin-top: 0px;text-align: right;">
                                    <li>
                                        <a id="cer_venepiaten" href="#" title="Cancelar">
                                            <img src="../images/cancel.png" alt="Cancelar"><br>
                                        </a>
                                    </li>
                                    <!--<li>
                     ...
                     <!--//////////////////////////////////////////////////////////////////////-->   
                        ...
                        <div class="container">
                            <div style="width: 100%">
                                <div class="onecolumn">
                                    <div class="header">
                                        <span><center>Registrar Epicrisis Atencion de Urgencias</center></span>
                                    </div>
                                    <!--<br class="clear">-->
                                    ...
                                    <!--<div style="height: 980px; width: 95%;" id='cp'>-->                                            
                                        <div id='conte'  style="height: 400px; width: 100%;">  
                                            <center>
                                            <ul class='tabs'>
                                                <li id='td1'><a id='t1'  href='#tab1' style='font-size: 14px;font-weight: bold;'>1. IDENTIFICACI&Oacute;N</a></li>
                                                <li id='td2'><a href='#tab2' style='font-size: 14px;font-weight: bold;'>2. INGRESO</a></li>
                                                <li id='td3'><a href='#tab3' style='font-size: 14px;font-weight: bold;' >3. EVOLUCION</a></li>
                                                <li id='td4'><a href='#tab4' style='font-size: 14px;font-weight: bold;' >4. EGRESO</a></li>
                                            </ul>
                                            <form id='form_epicrisis_aten' name='form_epicrisis_aten' action='' method='POST'>                                                                                            
